...
PROMPT = (
    "Eres una IA experta en análisis de documentos financieros: facturas, boletas, vouchers de billeteras digitales (Yape, Plin, Tunki, Lemonpay) y vouchers/movimientos bancarios (BCP, Interbank, Scotiabank, BBVA).\n"
...
SCHEMA = {
    ...
    "properties": {
        "tipo_documento": {"type": "string", "enum": [
            "factura","boleta","yape","plin","tunki","lemonpay","bcp","interbank","scotiabank","bbva",
            "FACTURA","BOLETA","YAPE","PLIN","TUNKI","LEMONPAY","BCP","INTERBANK","SCOTIABANK","BBVA"
        ]},
